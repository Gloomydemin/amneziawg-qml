            ...
            leadingActions: UITK.ListItemActions {
                actions: [
                    UITK.Action {
                        ...
                        onTriggered: {
                            // сохраняем значения, чтобы асинхронно не уехать
                            var idx = rowIndex
                            var name = profile_name

                            python.call("vpn.instance.delete_profile", [name],
                                        function (res) {
                                            // res = { ok: bool, message: string }
                                            if (!res.ok) {
                                                console.log(res.message)
                                                toast.show(i18n.tr("Failed: ") + res.message)
                                                return
                                            }

                                            toast.show(i18n.tr("Profile %1 deleted").arg(name))
                    ...
                    UITK.Action {
                        ...
                        onTriggered: {
                            stack.push(Qt.resolvedUrl("ProfilePage.qml"), {
                                ...
                                // добавляем AmneziaWG-поля, если есть в модели
                                "jc": jc,
                                "jmin": jmin,
                                "jmax": jmax
                            })
                ...
                Repeater {
                    ...
                    delegate: RowLayout {
                        ...
                        Row {
                            ...
                            visible: peerUp
                            UITK.Icon {
                                source: '../../assets/controls/arrow_down.png'
                            ...
                            UITK.Icon {
                                source: '../../assets/controls/arrow_up.png'
                                height: parent.height
                                keyColor: 'black'
                                color: 'green'
                            }
